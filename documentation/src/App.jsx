...
const MadeBy = () => (
  <div className='made-by'><span role="img" aria-label="symbol"></span></div>
);
...
const App = () => {
  ...
  const genAI = new GoogleGenerativeAI('api_keys'); // Replace 'YOUR_API_KEY' with your actual API key
  ...
  return (
    <div>
      ...
      <h1 >Legal Adviser</h1>
        ...
        <button onClick={() => window.location.href = 'http://127.0.0.1:8000/chat'}>
      Back
    </button>
